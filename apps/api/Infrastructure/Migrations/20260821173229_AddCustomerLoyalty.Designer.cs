...
namespace VendemeFacil.Api.Infrastructure.Migrations
{
    ...
    [Migration("20260821173229_AddCustomerLoyalty")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VendemeFacil.Api.Domain.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset>("ClientCreatedAtUtc")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("VendemeFacil.Api.Domain.Tenant", b =>
                {
                    ...
                    b.Property<int>("LayawayReminderDaysBefore")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("LoyaltyActive")
                        .HasColumnType("bit");

                    b.Property<decimal>("LoyaltyCashbackPercent")
                        .HasPrecision(5, 2)
                    ...
                    b.Property<bool>("PrintingConfigured")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("VendemeFacil.Api.Domain.LayawayItem", b =>
                {
                    b.HasOne("VendemeFacil.Api.Domain.Layaway", "Layaway")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("VendemeFacil.Api.Domain.LayawayPayment", b =>
                {
                    ...
                    b.HasOne("VendemeFacil.Api.Domain.CashSession", "CashSession")
                        .WithMany()
                        .HasForeignKey("TenantId", "CashSessionId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("VendemeFacil.Api.Domain.PasswordResetToken", b =>
                {
                    b.HasOne("VendemeFacil.Api.Domain.AppUser", "User")
                        .WithMany()

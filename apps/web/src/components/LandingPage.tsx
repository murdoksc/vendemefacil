...
type LandingPageProps = {
  onAccess: (mode?: "login" | "register") => void;
  onPrinting: () => void;
};
  ...
  return <main className="marketing-page">
    ...
    <section className="marketing-hero" id="inicio">
      <div className="hero-copy">
        <span className="hero-pill"><Sparkles /> Tu negocio, más fácil de controlar</span>
        <h1>Vende más.<br /><em>Administra mejor.</em></h1>
        <p>El punto de venta hecho para negocios que quieren crecer: ventas, inventario, caja, clientes y apartados, todo desde un mismo lugar.</p>
    ...
    <footer className="marketing-footer"><div className="marketing-logo"><span>VF</span><strong>Véndeme Fácil</strong></div><p>Ventas, inventario y control para hacer crecer tu negocio.</p><div><button onClick={() => onAccess("login")}>Iniciar sesión</button><button onClick={onPrinting}>Configurar impresión</button><a href="#contacto">Contacto</a></div><small>© {new Date().getFullYear()} Véndeme Fácil. Todos los derechos reservados.</small></footer>
  </main>;
}
